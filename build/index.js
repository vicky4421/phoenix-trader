...
const phoenix_sdk = __importStar(require("@ellipsis-labs/phoenix-sdk"));
const execute = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const client = yield phoenix_sdk.Client.create(connection);
    ...
    const setupNewMakerIxs = yield phoenix_sdk.getMakerSetupInstructionsForMarket(connection, marketState, traderKeypair.publicKey);
    ...
    do {
        ...
        try {
            ...
            const cancelTxId = yield (0, web3_js_1.sendAndConfirmTransaction)(connection, cancelTransaction, [traderKeypair], {
                skipPreflight: true,
                commitment: "confirmed",
            });
        ...
        try {
            ...
            const bidLimitOrderTx = client.getLimitOrderInstructionfromTemplate(marketPubkey.toBase58(), traderKeypair.publicKey, bidOrderTemplate);
